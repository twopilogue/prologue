...
public class PostsController {
    ...
    public ResponseEntity<? extends BaseResponseBody> writeDetailPost(@Valid WriteDetailPostRequest writeDetailPostRequest, @RequestPart (required = false) List<MultipartFile> files) {
